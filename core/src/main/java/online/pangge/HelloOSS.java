...
public class HelloOSS {
    ...
    private static String accessKeyId = "LTAIQ2JW18nVq5co";
    private static String accessKeySecret = "4TTXozSBoVZ6ysrBCSmtqWID2QjNjY";

    // Bucket用来管理所存储Object的存储空间，详细描述请参看“开发人员指南 > 基本概念 > OSS基本概念介绍”。
    // Bucket命名规范如下：只能包括小写字母，数字和短横线（-），必须以小写字母或者数字开头，长度必须在3-63字节之间。
    private static String bucketName = "pangge";
...
//            // 链接地址是：https://help.aliyun.com/document_detail/oss/sdk/java-sdk/upload_object.html?spm=5176.docoss/user_guide/upload_object
//            String fileKey = "IMG_6572.JPG";
//            File f = new File("G:\\ideaworkspace\\wechat\\src\\main\\java\\com\\qjj\\IMG_6572.JPG");
//            System.out.println("can read = "+f.canRead()+",can write = "+f.canWrite()+",can exec = "+f.canExecute()+",total space = "+f.getTotalSpace());
////            ossClient.putObject(bucketName, fileKey, f);
//            PutObjectResult result = ossClient.putObject(bucketName, fileKey, f);
...
////                URL url = ossClient.generatePresignedUrl(bucketName,fileKey,expires);
